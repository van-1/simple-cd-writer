...
public:
    ...
    static QStringList extractFilesFromCheckableProxyModel(CheckableProxyModel *model, const QModelIndex &proxyParent, bool appendParent = true, bool extractCheckedOnly = true);
